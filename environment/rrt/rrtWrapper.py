...
class RRTWrapper:
    def __init__(self, env_config, gui=False):
        from environment.utils import create_ur5s, Target, create_obstacles
    ...
    def birrt(self, start_conf, goal_conf,
              ur5_poses, target_eff_poses, obs_conf={},
        ...
        self.ur5_group.setup(ur5_poses, start_conf, obs_conf=obs_conf)
