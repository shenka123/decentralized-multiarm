...
class UR5Group:
    def __init__(self, create_ur5s_fn, collision_distance, all_obs={}):
        self.all_controllers = create_ur5s_fn()
        self.all_obs = all_obs
        self.active_controllers = []
        self.collision_distance = collision_distance

    def setup(self, start_poses, start_joints, obs_conf={}):
        self.disable_all_ur5s()
        self.enable_ur5s(count=len(start_poses))
        self.disable_all_obstacles()
        self.enable_obstacles(obs_list=obs_conf.keys())
